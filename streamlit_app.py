...
# Function to read PDF and convert to DataFrame using pdfplumber
def pdf_to_csv_plumber(pdf_file):
...
# Function to read PDF and convert to CSV using tabula
...
if theory_pdf and lab_pdf:
    with st.spinner('Processing...'):
        df_theory = pdf_to_csv_tabula(theory_pdf)
        df_lab = pdf_to_csv_tabula(lab_pdf)
...
# Function to update the table with selected slots
...
# Function to handle course application with color
...
# Function to handle course updating
...
# Sidebar actions for modifying courses
